...
function App() {
  ...
  return (
    <div style={{ backgroundColor: bgColor, height: '100vh',width:'1500px',display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
      ...
      <h1 className=' font-weight: 700'>Choose a Background Color!!!</h1>
        <button className='rounded-5 bg-primary' onClick={() => changeColor('skyblue')} style={buttonStyle}>Blue</button>
